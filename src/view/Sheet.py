...
class Sheet(QScrollArea):
    ...
    def dragEnterEvent(self, e: QDragEnterEvent) -> None:
        ...
        if widget is None or not isinstance(widget, Card):
            return
        card: Card = cast(Card, widget)
        size: QSize = QSize()
        size.setHeight(
    ...
    def cells_free(self, new_card: Card, column: int, row: int) -> bool:
        """
    ...
    def add_card(self, card: Card, column: int, row: int) -> bool:
        """
